...
public class MyGdxGame extends ApplicationAdapter {
	SpriteBatch batch,mapBatch,enemyBatch;
	...
	Animation enemyWalkRight,enemyWalkLeft,enemyWalkUp,enemyWalkDown,enemyIdle;
	float x, y, xv, yv;
	...
	//This is used to define items TODO MAKE THIS VERY BRIGHT THIS IS A A METHOD OF DEFINING SET ITEMS TO BE USED LATER
	//I still have to play around and see if calling a method in this method would still be a viable
	//way of creating new objects and terrains
	@Override
	public void create () {
...
//
//		getTileSets.getTileSet(fieldMap);
	...
	//this is a rendering method I still have to research if I can have more than one of these active or if I am confined
	//to only having one per program either way I can create more methods to run inside this one
	//I can kind of use this as a main method almost
	@Override
	public void render () {
		...
		enemyBatch.begin();
		enemyBatch.draw(enemyImg,enemyX,enemyY,DRAW_WIDTH,DRAW_HEIGHT);
		enemyBatch.end();
	}
	...
	//this is the move method for the player using the deceleration method to add velocity to movement
	void move() {
		if (Gdx.input.isKeyPressed(Input.Keys.UP)) {
	...
	//this is a method to use velocity metrics in the move formula gives the closer the float deceleration
	//number the faster the player comes to a halt
